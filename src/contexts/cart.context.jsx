...
const cartReducer = (state, action) => {
  ...
  switch (type) {
    ...
    case CART_ACTION_TYPES.TOGGLE_DROP_DOWN:
      return {
        ...state,
        isCartOpen: payload.toggledValue,
      };
    default:
...
export const CartProvider = ({ children }) => {
  ...
  const updateCartItemReducer = (newCartItems) => {
    ...
    const newCartTotal = newCartItems.reduce(
      (previousValue, { quantity, price }) => previousValue + quantity * price,
      0
    );
  ...
  const setIsCartOpen = (toggledValue) => {
    dispatch(
      createAction(CART_ACTION_TYPES.TOGGLE_DROP_DOWN, { toggledValue })
    );
  };
